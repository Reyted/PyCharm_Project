...
file_path_xlsx = 'C:/Users/24253/Desktop/工作内容/25年每月例行工作/1月工作内容/指标统计2.xlsx'
...
def read_excel(file_path):
    ...
    for li in df2.values:
        ...
        lst_li = list(li)
        try:
            if gc_band[lst_li[4]] == 'n41':
                band_count['n41'] += 1
            if gc_band[lst_li[4]] == 'n28':
                band_count['n28'] += 1
        except:
            pass
        # 计算各频段干扰个数
        try:
            ...
            if gc_band[lst_li[4]] == 'n41' and sinr_num > -107.0:
                band_count_sinr['n41'] += 1
            if gc_band[lst_li[4]] == 'n28' and sinr_num > -107.0:
...
def count_data():
    ...
    count_list.append([time_str, '华为', 2.6, band_count['n41']] + two_list[:12] + [band_count_sinur['n41'] / band_count['n41']] + seven_list[12:])
    # print(two_list[12:])
...
def main():
    ...
    # print(data_list)
    append_data_to_excel(file_path_xlsx, sheet_name, data_list)
