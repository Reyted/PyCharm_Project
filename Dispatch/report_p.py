...
def creat_report(url_attach,url_tpl,url_img,city):
    wb = xw.Book(
        f'{url_attach}{city}LTE测试分析优化问题点12月.xlsx')
...
if __name__ == '__main__':
    monthind=12
    url_attach=f'C:/Users/24253/Desktop/每月例行工作/{monthind}月工作内容/{monthind}月工单报告/{monthind}月工单报告附件/'
    url_tpl=f'C:/Users/24253/Desktop/每月例行工作/{monthind}月工作内容/{monthind}月派单回单/派单/'
    url_img=f'C:/Users/24253/Desktop/每月例行工作/{monthind}月工作内容/{monthind}月派单回单/image/'
    city_lst=['昌都至类乌齐国道'] #,
